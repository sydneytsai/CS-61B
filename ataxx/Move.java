...
class Move {
    ...
    private Move(int col0, int row0, int col1, int row1) {
        ...
        boolean first = _col1 == _col0 && 1 >= abs(row1 - row0);
        boolean second = _row1 == _row0 && 1 >= abs(col1 - col0);
        boolean third = 1 >= abs(col1 - col0) && 1 >= abs(row1 - row0);
    ...
    public String toString() {
        if (isPass()) {
            ...
            String ans = "" + col0() + row0() + "-" + col1() + row1();
            return (ans);
        }
    }
